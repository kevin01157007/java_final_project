...
public class OpenAIChat {
    public static String sendOpenAIRequest(String message) throws Exception {
        try {
            ...
            String jsonMessages = "[" +
                    "{\"role\": \"system\", \"content\": \"" + "You are a college student studying in Taiwan now ， you need to answer the question and reply the email with chinese as you are a Taiwannese student." + "\"}," +
